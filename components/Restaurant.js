  ...
  return (
    ...
    onPress={()=>router.push({
      ...
      params:{
        ...
        cuisunes: item.cuisunes,
        aggregate_rating: item.aggregate_rating,
        no_of_Delivery: item.no_of_Delevery
      }
    })}
    style={{
        marginHorizontal:6,
      ...
      <View style={{flexDirection:"row", alignItems:"center", justifyContent:"space-between"}}>
        <View style={{paddingVertical:4, paddingHorizontal:3}}>
            ...
            <Text style={{paddingHorizontal:10, marginTop:3, fontSize:14, fontWeight:"500", color:"#505050"}}>Hanoi • Fast Food • 160 for one</Text>
            <Text>{item?.time}</Text>
        </View>
